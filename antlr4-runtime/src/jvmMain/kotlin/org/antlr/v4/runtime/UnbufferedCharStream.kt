...
abstract class UnbufferedCharStream(
    bufferSize: Int = 256,
        ...
        constructor(input: InputStream?, name: String) : this(input, 256)

        constructor(input: InputStream?, bufferSize: Int) : this(input, bufferSize, Charsets.UTF_8)
        ...
        protected fun nextChar(): Int = input?.read() ?: IntStream.EOF
