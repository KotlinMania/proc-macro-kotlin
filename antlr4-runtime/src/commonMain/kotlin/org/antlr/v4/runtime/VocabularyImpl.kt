...
class VocabularyImpl(literalNames: Array<String?>?, symbolicNames: Array<String?>?, displayNames: Array<String?>?) :
    ...
    init {
        this.literalNames =
            if (literalNames != null) literalNames else org.antlr.v4.runtime.VocabularyImpl.Companion.EMPTY_NAMES
        this.symbolicNames =
            if (symbolicNames != null) symbolicNames else org.antlr.v4.runtime.VocabularyImpl.Companion.EMPTY_NAMES
        this.displayNames =
            if (displayNames != null) displayNames else org.antlr.v4.runtime.VocabularyImpl.Companion.EMPTY_NAMES
