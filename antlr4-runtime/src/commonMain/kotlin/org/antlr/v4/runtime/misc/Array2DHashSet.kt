...
open class Array2DHashSet<T> @kotlin.jvm.JvmOverloads constructor(
    ...
    init {
        this.comparator = if (comparator is AnyEqualityComparator && this !is AnyEqualityComparator)
    ...
    private inner class SetIterator(val data: Array<T>) : MutableIterator<T> {
        var nextIndex: Int = 0
