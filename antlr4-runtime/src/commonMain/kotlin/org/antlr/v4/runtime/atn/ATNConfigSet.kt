...
open class ATNConfigSet @kotlin.jvm.JvmOverloads constructor(
    ...
    fun add(config: ATNConfig, mergeCache: DoubleKeyMap<PredictionContext, PredictionContext, PredictionContext>?): Boolean {
        ...
        val merged = PredictionContext.merge(
            existing.context, config.context, fullCtx, mergeCache
        )
        ...
        existing.reachesIntoOuterContext = maxOf(
