...
open class ParserATNSimulator(
    ...
    protected fun execATN(
        ...
        while (true) { // while more work
            ...
            if (D!!.requiresFullContext && mode !== PredictionMode.SLL) {
                ...
                if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.dfa_debug) {
                    println(
                        "ctx sensitive state " + outerContext + " in " + D,
                    )
                }
                val fullCtx = true
     ...
     * already cached
     */
    open fun getExistingTargetState(
        previousD: DFAState,
        t: Int,
    ): DFAState? {
    ...
    protected fun predicateDFAState(
        dfaState: DFAState,
...
// 			println("reach="+reach+", "+reach!!.conflictingAlts);
    ...
    open fun computeReachSet(
        ...
        if (skippedStopStates == null && t != Token.EOF) {
            if (intermediate.size === 1) {
                ...
                reach = intermediate
            } else if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion
                    .getUniqueAlt(intermediate) != ATN.INVALID_ALT_NUMBER
            ) {
                // Also don't pursue the closure if there is unique alternative
                // among the configurations.
                reach = intermediate
        ...
        if (reach == null) {
            ...
            val closureBusy: MutableSet<ATNConfig> = HashSet<ATNConfig>()
     ...
     */
    protected fun removeAllConfigsNotInRuleStopState(
    ...
    protected fun computeStartState(
        ...
        if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.trace_atn_sim) {
            println(
                "computeStartState from ATN state " + p + " initialContext=" +
    ...
    protected fun applyPrecedenceFilter(configs: ATNConfigSet): ATNConfigSet {
        val statesFromAlt1: MutableMap<Int, PredictionContext?> = HashMap<Int, PredictionContext?>()
        ...
        for (config in configs) {
            ...
            if (!config.isPrecedenceFilterSuppressed) {
                 ...
                 */
                val context: PredictionContext? = statesFromAlt1[config.state.stateNumber]
...
// 		}
        ...
        if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.debug) {
            println(
                "getPredsForAmbigAlts result " + altToPred.contentToString(),
            )
        }
        return altToPred
    }
    ...
    protected fun getPredicatePredictions(
        ...
        for (i in 1..<altToPred!!.size) {
            val pred: SemanticContext = altToPred[i]!!
    ...
    open fun evalSemanticContext(
        ...
        for (pair in predPredictions) {
            ...
            if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.debug ||
                org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.dfa_debug
            ) {
    ...
    open fun evalSemanticContext(
        ...
        alt: Int,
        fullCtx: Boolean,
    ): Boolean = pred.eval(parser, parserCallStack)
...
//            if ( debug ) println("added config "+configs);
    ...
    protected fun canDropLoopEntryEdgeInLeftRecursiveRule(config: ATNConfig): Boolean {
        ...
        for (i in 0..<numCtxs) { // for each stack context
            ...
            if (blockEndState != null && returnState === blockEndState!!) {
                continue
            }
            // Look for ternary expr ? expr : expr. The return state points at block end,
            // which points at loop entry state
            if (blockEndState != null && returnStateTarget === blockEndState!!) {
                continue
            }
    ...
    protected fun actionTransition(
        config: ATNConfig?,
        t: ActionTransition,
    ): ATNConfig? {
    ...
    open fun reportAttemptingFullContext(
        dfa: DFA,
        conflictingAlts: BitSet?,
        configs: ATNConfigSet?,
        startIndex: Int,
        ...
        if (org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.debug ||
            org.antlr.v4.runtime.atn.ParserATNSimulator.Companion.retry_debug
        ) {
    ...
    open fun reportContextSensitivity(
        dfa: DFA,
        prediction: Int,
        configs: ATNConfigSet?,
        startIndex: Int,
    ...
    companion object {
        ...
        val TURN_OFF_LR_LOOP_ENTRY_BRANCH_OPT: Boolean =
            getSafeEnv("TURN_OFF_LR_LOOP_ENTRY_BRANCH_OPT")?.toBooleanStrictOrNull() ?: false
        ...
        fun getSafeEnv(envName: String?): String? = null
    }
}
