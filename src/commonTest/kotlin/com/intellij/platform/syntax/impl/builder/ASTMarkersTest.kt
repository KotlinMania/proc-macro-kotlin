...
internal class ASTMarkersTest {
    ...
    @Test
    fun substituteChameleonRemoved() {
    ...
    private infix fun MarkerKind.shouldBe(expected: MarkerKind) {
        assertEquals(expected, this)
    }
    ...
    private infix fun ChameleonRef.shouldBe(expected: ChameleonRef) {
        assertEquals(expected, this)
    }
}
