...
// Vendored from JetBrains/kotlin compiler/multiplatform-parsing/common/src/org/jetbrains/kotlin/kmp/utils/SyntaxElementTypesWithIds.kt
...
abstract class SyntaxElementTypesWithIds {
     ...
     */
    fun getElementTypeId(syntaxElementType: SyntaxElementType?): Int =
        syntaxElementType?.index?.let { indexToIdMap[it] } ?: NO_ID

    fun register(
        id: Int,
        name: String,
    ): SyntaxElementType =
        SyntaxElementType(name).also {
