...
// Vendored from JetBrains/kotlin compiler/multiplatform-parsing/common/src/gen/KotlinFlexLexer.kt
...
class KotlinFlexLexer : FlexLexer {
    companion object {
        ...
        private val ZZ_LEXSTATE: IntArray =
            intArrayOf(
                0,
                0,
                1,
        ...
        private fun zzUnpackcmap_blocks(
            packed: String,
            offset: Int,
            result: IntArray,
        ): Int {
        ...
        private fun zzUnpackAction(): IntArray {
            val result: IntArray = IntArray(234)
            var offset: Int = 0
            offset = zzUnpackAction(ZZ_ACTION_PACKED_0, offset, result)
            return result
        }

        private fun zzUnpackAction(
            packed: String,
            offset: Int,
            result: IntArray,
        ): Int {
        ...
        private fun zzUnpacktrans(): IntArray {
            val result: IntArray = IntArray(10540)
            var offset: Int = 0
            offset = zzUnpacktrans(ZZ_TRANS_PACKED_0, offset, result)
            return result
        }

        private fun zzUnpacktrans(
            packed: String,
            offset: Int,
            result: IntArray,
        ): Int {
    ...
    private class State(
        val state: Int,
        val lBraceCount: Int,
        val requiredInterpolationPrefix: Int,
    ) {
        override fun toString(): String =
            "yystate = $state" +
                (if (lBraceCount == 0) "" else "lBraceCount = $lBraceCount") +
                (
                    if (requiredInterpolationPrefix ==
                        -1
                    ) {
                        ""
                    } else {
                        "requiredInterpolationPrefix = $requiredInterpolationPrefix"
                    }
                )
    }
     ...
     */
    override fun yystate(): Int = zzLexicalState
     ...
     */
    fun yytext(): CharSequence = zzBuffer.subSequence(zzStartRead, zzMarkedPos)
     ...
     */
    fun yycharat(position: Int): Char = zzBuffer[zzStartRead + position]

    /**
     * Returns the length of the matched text region.
     */
    fun yylength(): Int = zzMarkedPos - zzStartRead
    ...
    internal fun CharSequence.offsetByCodePoints(
        index: Int,
        codePointOffset: Int,
    ): Int {
    ...
    internal fun Char.Companion.toCodePoint(
        high: Char,
        low: Char,
    ): Int = (((high - MIN_HIGH_SURROGATE) shl 10) or (low - MIN_LOW_SURROGATE)) + 0x10000
