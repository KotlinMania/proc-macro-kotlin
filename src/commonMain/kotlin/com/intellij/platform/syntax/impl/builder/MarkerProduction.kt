...
internal class MarkerProduction(
    ...
    private fun hasError(marker: ProductionMarker): Boolean =
        marker is ErrorMarker || myOptionalData.getDoneError(marker.markerId) != null
