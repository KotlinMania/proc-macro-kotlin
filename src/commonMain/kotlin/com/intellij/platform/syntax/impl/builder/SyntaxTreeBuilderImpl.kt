...
internal class SyntaxTreeBuilderImpl(
  ...
  internal fun processDone(marker: CompositeMarker, errorMessage: String?, before: CompositeMarker?) {
...
private const val UNBALANCED_MESSAGE: String = "Unbalanced tree. Most probably caused by unbalanced markers. " +
