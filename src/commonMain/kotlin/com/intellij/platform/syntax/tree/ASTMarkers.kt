...
internal interface ChameleonRef {
...
internal data class ChameleonChange(
    val lexemeIndex: Int,
...
internal interface ASTMarkers {
    ...
    fun chameleons(): List<ChameleonChange>
    ...
    interface MutableContext {
        ...
        fun changeChameleons(changes: List<ChameleonChange>)
...
internal fun ASTMarkers.prevSibling(markerIndex: Int): Int =
    if (markerIndex == 0) {
        -1
    } else {
...
internal fun ASTMarkers.nextSibling(markerIndex: Int): Int =
    when (kind(markerIndex)) {
        MarkerKind.Start -> {
...
internal fun ASTMarkers.lastChild(markerIndex: Int): Int =
    when (kind(markerIndex)) {
...
internal fun ASTMarkers.firstChild(markerIndex: Int): Int {
