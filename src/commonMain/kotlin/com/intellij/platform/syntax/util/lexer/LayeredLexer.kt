...
import com.intellij.util.NullableBooleanThreadLocalKmp
import com.intellij.util.nullableBooleanThreadLocalKmp

open class LayeredLexer(
    delegate: Lexer,
    ...
    internal fun registerSelfStoppingLayer(
        lexer: Lexer,
    ...
    internal fun registerLayer(
        lexer: Lexer,
        vararg startTokens: SyntaxElementType,
    ) {
        if (DISABLE_LAYERS_FLAG.get() == true) return
    ...
    companion object {
        ...
        internal val DISABLE_LAYERS_FLAG: NullableBooleanThreadLocalKmp = nullableBooleanThreadLocalKmp()
    }
}
