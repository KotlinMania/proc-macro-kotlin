...
open class StringLiteralLexer(
    ...
    protected open fun handleSingleSlashEscapeSequence(): SyntaxElementType =
    ...
    protected open fun locateHexEscapeSequence(
        start: Int,
        i: Int,
    ): Int {
        var i = i + 1
    ...
    protected open fun locateUnicodeEscapeSequence(
        start: Int,
        i: Int,
    ): Int {
        var i = i + 1
    ...
    protected open fun locateAdditionalEscapeSequence(
        start: Int,
        i: Int,
    ): Int = -1
...
private inline fun Logger.assertTrue(
    condition: Boolean,
    message: (() -> String),
): Boolean {
    if (!condition) {
