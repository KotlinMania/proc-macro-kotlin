...
object Arrays {
    ...
    fun ensureOffsetLength(
        ...
        if (length >
            ...
            throw IndexOutOfBoundsException(
                "Last index (" + (offset.toLong() + length) + ") is greater than array length (" + arrayLength + ")",
            )
        }
    }
    ...
    fun ensureFromTo(
        ...
        if (to >
            ...
            throw IndexOutOfBoundsException("End index ($to) is greater than array length ($arrayLength)")
        }
    }
}
