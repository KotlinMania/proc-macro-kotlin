...
interface IntList {
    ...
    companion object {
         ...
         */
        fun of(): IntList = IntArrayList.of()
         ...
         */
        fun of(e: Int): IntList = IntArrayList.of(e)
        ...
        fun of(
            ...
            e1: Int,
            e2: Int,
        ): IntList = IntArrayList.of(e0, e1, e2)
         ...
         */
        internal fun of(vararg a: Int): IntList {
            when (a.size) {
                0 -> return of()
                1 -> return of(a[0])
                else -> {}
