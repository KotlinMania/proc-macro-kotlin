...
object IntArrays {
    ...
    fun ensureCapacity(
        ...
        if (length > array.size) {
            forceCapacity(array, length, preserve)
        } else {
            array
        }
    ...
    fun grow(
        array: IntArray,
        length: Int,
    ): IntArray = grow(array, length, array.size)
    ...
    fun unwrap(i: IntIterator): IntArray = unwrap(i, Int.MAX_VALUE)
    ...
    fun unwrap(
        i: IntIterator,
        array: IntArray,
    ): Int = unwrap(i, array, 0, array.size)
