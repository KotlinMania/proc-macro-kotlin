...
class Int2IntOpenHashMap : MutableInt2IntMap {
    /** The array of keys.  */
    ...
    fun defaultReturnValue(): Int = defaultValue
    ...
    private fun rehash(newN: Int) {
        ...
        while (j-- != 0) {
            ...
            if (newKey[(HashCommon.mix(key[i]) and mask).also { pos = it }] != 0) {
