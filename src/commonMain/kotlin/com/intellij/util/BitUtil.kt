...
object BitUtil {
    ...
    fun clear(value: Byte, mask: Byte): Byte = set(value, mask, false)

    fun clear(value: Int, mask: Int): Int = set(value, mask, false)

    fun clear(value: Long, mask: Long): Long = set(value, mask, false)
