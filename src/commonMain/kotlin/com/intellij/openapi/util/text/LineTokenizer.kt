...
internal class LineTokenizer(
    ...
    companion object {
        ...
        fun tokenize(chars: CharArray, includeSeparators: Boolean, skipLastEmptyLine: Boolean = true): Array<String> = tokenize(chars, 0, chars.size, includeSeparators, skipLastEmptyLine)
        ...
        ): Array<String> = tokenize(CharArrayCharSequence(chars, startOffset, endOffset), includeSeparators, skipLastEmptyLine)

        private fun stringEndsWithSeparator(tokenizer: LineTokenizer): Boolean = tokenizer.lineSeparatorLength > 0
    }
}
